...
# Slide 1 : Architecture réseaux de la partie Développement
title "1. Architecture réseaux de la partie développement"
echo "Commande pour vérifier l'architecture réseau :"
...
echo "lancement du docker compose prod"
docker compose -f project/reverse-proxy/docker-compose.yml up -d
docker compose -f project/docker-compose.prod.yml logs -f
# crtl + c
docker compose -f project/docker-compose.prod.yml up -d
docker compose -f project/docker-compose.prod.yml logs -f
#ctrl + c
...
cat project/reverse-proxy/docker-compose.yml
wait_for_key
echo -e "\033[1;35mdocker network ls\033[0m"
docker network ls | grep "proxy-*\|database-*"
wait_for_key
